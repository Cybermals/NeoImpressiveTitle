...
class FloatingWindow(DragBehavior, Widget):
    ...
    def on_touch_down(self, touch):
        ...
        if self.collide_point(touch.x, touch.y):
            # Bring this widget to the top of the z-order by removing it from its parent and adding it back to
            # its original parent.
            parent = self.parent
    ...
    def on_close(self):
        # Remove this widget from its parent. If you need to reopen it later, be sure to keep a reference
